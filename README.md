...
<div class="card bg-base-100 w-96 shadow-xl">
  <div class="card-body">
        ...
        <h2 class="card-title text-lg text-center">Login</h2>
        ...
        @csrf
            ...
            <div>
                <input  class="input input-primary w-full max-w-xs" type="text" name="email" id="email"
                ...
                <div>
                    <input class="input input-primary input-bordered"
